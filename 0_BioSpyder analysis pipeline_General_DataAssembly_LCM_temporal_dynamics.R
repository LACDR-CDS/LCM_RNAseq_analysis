...
CountThreshold <- 10                              #Exclude samples lower than this number for percentage map
...
CountTableDir <- "//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/2021/LCM_Part2/data" #Folder containing only raw count table files (csv or excel files)
CountTableDir_2 <- "//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/2021/LCM_Part2/Replicate_2/Count"
inputDir <-  '//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/2021/LCM_Part2/Replicate_2/' #Store metadata file and raw count files here
outputDir_GR <- '//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/2021/LCM_Part2/Replicate_2/'
#GeneListDir <- '//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/sysbioptop/Biospyder/Data_processing/Genelists/' #store specific gene lists as txt files here
#output_IPA <- '//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/sysbioptop/Biospyder/Data_processing/IPA_input/' #Directory for txt files to use as IPA input 

scriptDir <- "//VUW/Personal$/Homes/W/wijayals/Desktop/Experiments/2021/LCM_Part2/script/"
source(file.path(scriptDir, "A_BioSpyder analysis pipeline_Lib_LCM_temporal_dynamics.R"))
...
##batch2_seq
count_2 <- LoadCountData(CountTableDir_2)
...
###sum the count of each probe for the technical replicates##
##technical replictes == CELL_ID
...
write.table(df_DEGs, file = paste0("DEGsfiltered_vs_correctControl.txt"), sep = "\t")
